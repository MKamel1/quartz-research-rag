...
## Connections
- [[.has_idf_modifier()]] - `calls` [EXTRACTED]
- [[.point_count()]] - `calls` [EXTRACTED]
- [[.rebuild()]] - `calls` [EXTRACTED]
- [[Config]] - `references` [EXTRACTED]
- [[ContractError]] - `calls` [EXTRACTED]
- [[Path_10]] - `references` [EXTRACTED]
- [[ReindexableVectorStore]] - `references` [EXTRACTED]
- [[The full OG-27 flow -- see module docstring for the three safety layers. Returns]] - `rationale_for` [EXTRACTED]
- [[_verify_snapshot_present()]] - `calls` [EXTRACTED]
- [[main()_5]] - `calls` [EXTRACTED]
- [[reindex_idf.py]] - `contains` [EXTRACTED]
