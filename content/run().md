...
- [[Client_1]] - `references` [EXTRACTED]
- [[Config]] - `references` [EXTRACTED]
- [[Harvester]] - `calls` [EXTRACTED]
- [[One harvest-then-download pass. Returns how many NEW files this call downloaded.]] - `rationale_for` [EXTRACTED]
...
- [[_pdf_path()]] - `calls` [EXTRACTED]
- [[_skip_marker_path()]] - `calls` [EXTRACTED]
- [[arxiv_http_client()]] - `calls` [EXTRACTED]
- [[prefetch_loop()]] - `calls` [EXTRACTED]
